    ...
    <div class="flex  py-4 justify-center">
        ...
        <div class="flex justify-center mb-3 underline">
          ...
          <div class="mb-6">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="body" name="body" type="text" placeholder="Body" required>
          </div>
